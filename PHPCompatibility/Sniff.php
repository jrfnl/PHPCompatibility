...
abstract class Sniff implements PHPCS_Sniff
{
     ...
     *
     * @since 5.5
     * @since 7.0.7 Moved from the RemovedHashAlgorithmsSniff to the base sniff class.
     *
     * @var array
     */
     ...
     *
     * @since 7.0.7 Logic was originally contained in the RemovedHashAlgorithmsSniff.
     *
     * @param \PHP_CodeSniffer_File $phpcsFile Instance of phpcsFile.
